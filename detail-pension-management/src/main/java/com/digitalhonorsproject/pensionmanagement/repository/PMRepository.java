...
@Repository
public interface PMRepository extends CrudRepository<PMModel, Long>  // Crud to interact with DB
//& concept of Java Inheritence to inherit attributes and methods from one class to another
//(Superclass or Parent class--->CrudRepository & Subclass or Child class----->PMRepository)  
{
